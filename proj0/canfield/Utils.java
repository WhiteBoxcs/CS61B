...
public class Utils {
    ...
    /**
     * There are no objects of type Utils. By making its constructor private,
     * there is no way to create a Utils outside the class.
     */
    private Utils() {
    }
     ...
     * if NAME is null, has bad syntax or does not exist. Tries to read file
     * directly, and if that fails, tries to read the resource
