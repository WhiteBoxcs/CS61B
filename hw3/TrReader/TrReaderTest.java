...
public class TrReaderTest {
  ...
  /*
   * This test reads in the source code for itself. Then feeds it into TrReader. If it works, you
   * get the source for this test, but scrambled.
   */
  @Test
  public void testSource() throws IOException {
    Reader r = this.makeStringReader(new FileReader("TrReaderTest.java"), 4096);
  ...
  /**
   * Return a StringReader that contains the contents delivered by R, up to MAXSIZE characters. All
   * end-of-line sequences in the characters read are canonicalized to '\n' (this has an effect only
   * on Windows).
   */
  ...
  static final String TRANSLATION = "josh hug____jh_FjleRe_de ;\n" + "josh hug____jh_Re_de ;\n"
